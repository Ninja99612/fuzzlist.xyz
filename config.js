...
module.exports = {
  bot: {
    token: "OTU0ODUyMDUzOTM3NzAwOTM0.YjZJRQ.6woaur_ysWIF-FCx_557U1lHDVk",//your bot token for botlist
    prefix: "!",//your bot prefix for botlist
    owners: ["938171799139655700","831181411448651796"],//owners id
    mongourl: "mongodb+srv://ADMIN:YoitsNinja123@cluster0.bzr9x.mongodb.net/myFirstDatabase?retryWrites=true&w=majority",//mongodb url
    servers: {
      token: "OTU0ODUyMDUzOTM3NzAwOTM0.YjZJRQ.6woaur_ysWIF-FCx_557U1lHDVk",//your bot token for serverlist
      prefix: "!",
    }
  },
  ...
  website: {
    ...
    secret: "OmoOruX_EdEMGFT-bzmRs1CoSCKYrGgS",//your botlist bot's client secret
